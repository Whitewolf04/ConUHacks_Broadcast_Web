      ...
      <ListItem sx={{ mt: -1 }}>
        <Grid container spacing={0}>
          ...
          <Grid
            ...
            xs={12}
            md={2}
            sx={{ textAlign: { xs: "left", md: "right" }, pr: 1 }}
          >
            <ListItemText>
              {moment(new Date()).format("dddd MMMM D Y")}
            </ListItemText>
          </Grid>
        </Grid>
      </ListItem>
  ...
  render() {
    return (
      <Box>
        ...
        >
          <ListSubheader
            sx={{ textAlign: "left", pl: 3, bgcolor: "transparent" }}
          >
          ...
          <ListItem sx={{ mt: -1 }}>
            <Grid container spacing={0}>
              <Grid
                ...
                xs={12}
                md={10}
                sx={{ border: 2, borderRadius: 2, pl: 2 }}
              >
                <ListItemText primary="Announcement Headline"></ListItemText>
              </Grid>
              <Grid
...
class Twitter extends React.Component {
  render() {
    return (
      ...
      >
        <Box sx={{ textAlign: "center", fontWeight: "bold", pt: 3 }}>
          Twitter
        </Box>
        <Box>
          <GeneralAnnouncement />
